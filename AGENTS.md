...
- Keep recovery distinct from model repair attempts. A provider-free recovery qualification must bind its canonical digest, exact sealed-live corpus, complete N7 adapter digest set, checkpoint replay, duplicate-effect prevention, and zero live-provider boundary before it may satisfy the evaluator recovery gate.
