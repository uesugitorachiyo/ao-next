...
Native file effects use descriptor-bound Unix filesystem operations. Windows
builds compile the complete test surface but native file effects fail closed;
Windows execution is not yet qualified.
