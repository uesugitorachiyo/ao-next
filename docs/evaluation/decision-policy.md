...
- at least one successful N7 recovery with no duplicate effect, established by either a bound live measurement or a canonical provider-free recovery qualification derived by evaluator-owned deterministic probes in a fresh evidence root and bound to the exact sealed-live corpus, complete N7 adapter digest set, checkpoint replay, duplicate-effect denial, and zero-live-provider boundary;
